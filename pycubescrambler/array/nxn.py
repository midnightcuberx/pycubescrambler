...
def get3(scramnum=1,scramtype="3x3"):
  try:
    scramnum=int(scramnum)
  except (ValueError,TypeError,SyntaxError):
    scramtype1=scramnum
    scramnum1=scramtype
    scramtype=scramtype1
    scramnum=scramnum1
    if scramnum=="3x3":
      scramnum=1
  array=[]
  for i in range(scramnum):
    a=main.get3()
    scram= "".join(a)
    array.append(scram)
...
def get4(scramnum=1,scramtype="4x4"):
  try:
    scramnum=int(scramnum)
  except (ValueError,TypeError,SyntaxError):
    scramtype1=scramnum
...
def get5(scramnum=1, scramtype="5x5"):
  try:
    scramnum=int(scramnum)
  except (ValueError,TypeError,SyntaxError):
    scramtype1=scramnum
