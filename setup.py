...
setup(
  ...
  author_email = 'drcubing27@gmail.com',      # Type in your E-Mail
  url = 'https://github.com/midnightcuberx/pycubescrambler',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/midnightcuberx/pycubescrambler/archive/v_0.0.1.tar.gz',    # I explain this later on
